 ...
 *
 * Sustituye al `<select>` nativo, que en esta app se veía como una caja gris
 * del sistema operativo —distinta en cada navegador— en medio de una interfaz
 * que no lo es. Es el mismo componente que DINAMYT-LOCAL usa para sus menús,
 * traído aquí para que las dos aplicaciones se sientan una sola.
 *
